...
export default function Main({ children }) {
    ...
    return (
        <div className="min-h-screen bg-[#A00000]">
            <nav className="relative flex justify-between items-center px-10 py-6">
                ...
                <ul className={`lg:flex lg:items-center lg:w-auto lg:space-x-6 ${isMobileMenuOpen ? '' : 'hidden'}`}>
            ...
            <div className={`navbar-menu relative z-50 ${isMobileMenuOpen ? '' : 'hidden'}`}>
                ...
                <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
                    ...
                    <div className="mt-auto">
                        <div className="pt-6">
                            <Link className="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold bg-gray-50 hover:bg-gray-100 rounded-xl" href="#">Sign in</Link>
                            <Link className="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-600 hover:bg-blue-700  rounded-xl" href="#">Sign Up</Link>
                        </div>
